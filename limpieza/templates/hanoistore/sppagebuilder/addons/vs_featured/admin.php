...
SpAddonsConfig::addonConfig(
	array(
		'type'       => 'repeatable',
		'addon_name' => 'sp_vs_featured',
		'category'   => 'Vinasites',
		'title'      => JText::_( 'COM_SPPAGEBUILDER_ADDON_VM_PRODUCTS_FEATURED' ),
		'desc'       => JText::_( 'COM_SPPAGEBUILDER_ADDON_VM_PRODUCTS_FEATURED_DESC' ),
		'attr'       => array(
			'title'               => array(
				'type'  => 'text',
			...
			'repetable_item'=>array(
				'type'=>'repeatable',
				'addon_name' =>'sp_vs_featured_item',
				'title'=> 'Repetable',
				'attr'=>  array(
					'title'               => array(
						'type'  => 'text',
