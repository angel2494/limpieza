...
$show_qty = true;
if(isset($viewData['show_qty']))
	$show_qty = $viewData['show_qty'];
...
?>
	<div class="addtocart-area">
		<form method="post" id="addCart-<?php echo $product->virtuemart_product_id ?>" class="product js-recalculate" action="<?php echo JRoute::_ ('index.php?option=com_virtuemart',false); ?>">
			<div class="vm-customfields-wrap">
				...
				<?php
				if (!VmConfig::get('use_as_catalog', 0)  ) {
					echo shopFunctionsF::renderVmSubLayout('addtocartbar',array('product'=>$product,'show_qty'=>$show_qty));
				} ?>
