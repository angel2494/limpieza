...
<div class="orderby-displaynumber">
	<div class="floatleft vm-order-list">
		<ul class="icon_switch">
			<li rel="grid_products" class="grid active"><i class="fa fa-th-large"></i></li>
			<li rel="list_products" class="list"><i class="fa fa-th-list"></i></li>
		</ul>
		<?php echo shopFunctionsF::renderVmSubLayout('vs_orderby');?>
	</div>
	<div class="floatright display-number">
		<label><?php echo $this->vmPagination->getResultsCounter ();?></label>
