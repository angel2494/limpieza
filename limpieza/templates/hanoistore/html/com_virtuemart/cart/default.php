...
<div class="cart-view">
	...
	<div class="title">
		<h1><?php echo vmText::_ ('COM_VIRTUEMART_CART_OVERVIEW');?></h1>
		<div class="des"><?php echo JText::_ ('YOU_HAVE');?> <span><?php echo count($this->cart->products);?> <?php echo JText::_('ITEMS');?></span> <?php echo JText::_('IN_YOUR_CART');?></div>
	</div>
