            ...
            if ($this->order  ) {
                ...
                <div class="order-view">
                    ...
                    <form action="<?php echo JRoute::_( 'index.php', 1, $this->useSSL); ?>" method="post" name="com-login" >
                        ...
                        <div class="field_item" id="com-form-order-number">
                        ...
                        <div class="field_item" id="com-form-order-pass">
                        ...
                        <div class="field_item" id="com-form-order-submit">
        ...
        <div class="col-sm-6 col-xs-12">
            <form id="com-form-login" action="<?php echo $url; ?>" method="post" name="com-login" >
                <fieldset class="userdata">
                    ...
                    <?php }   ?>
                    <div class="field_item" id="com-form-login-username">
                        <label><?php echo vmText::_('COM_VIRTUEMART_USERNAME'); ?></label>
                    ...
                    <div class="field_item" id="com-form-login-password">
                        <label><?php echo vmText::_('COM_VIRTUEMART_PASSWORD'); ?></label>
                    ...
                    <div class="field_item" id="com-form-login-remember">
                ...
                <div class="field_item link_login">
