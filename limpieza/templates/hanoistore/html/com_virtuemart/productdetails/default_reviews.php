...
if ($this->allowRating || $this->allowReview || $this->showRating || $this->showReview) {
	...
	$ratingWidth = $maxrating*13;
	for( $num = 0; $num<=$maxrating; $num++ ) {
		$stars[] = '
				<span title="'.(vmText::_( "COM_VIRTUEMART_RATING_TITLE" ).$num.'/'.$maxrating).'" class="vmicon ratingbox" style="display:inline-block;width:'. 13*$maxrating.'px;">
