...
<ul class="catleft <?php echo $class_sfx ?>" id="<?php echo "VMmenu".$ID ?>" >
<?php foreach ($categories as $category) {
	$count = $categoryModel->countProducts($category->virtuemart_category_id);
...
<li <?php echo $active_menu ?>>
		<?php echo JHTML::link($caturl, $cattext.' <strong>('.$count.')</strong>', array('class'=>$category->slug));
