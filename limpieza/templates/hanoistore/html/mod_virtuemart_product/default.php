...
?>
<div class="vmgroup<?php echo $params->get ('moduleclass_sfx') ?> modProducts">
	...
	if ($display_style == "div") {
		...
		<div class="vmproduct<?php echo $params->get ('moduleclass_sfx'); ?> productdetails">
			...
			<div class="<?php echo $pwidth ?> <?php echo $float ?> item">
				<div class="spacer vs_clear">
					<div class="thumb floatleft">
						<?php
					...
					<div class="info floatleft">
						...
						<div class="star-rating">
							<?php echo shopFunctionsF::renderVmSubLayout('vs_rating',array('showRating'=>$showRating, 'show_review'=>0, 'product'=>$product));?>
						</div>
						<?php
						if ($show_price) {
