...
?>
<article class="item detail_recipe item-page<?php echo $this->pageclass_sfx . ( $this->item->featured ) ? ' item-featured' : ''; ?>"
	...
	<div class="content-inner">
		...
		if ( $post_format == 'standard' ) {
			...
			} elseif(isset($attribs1->spfeatured_image) && $attribs1->spfeatured_image != '') {
				$full_image = $attribs1->spfeatured_image;
			}
			echo '<img src="'.JURI::root().$full_image.'" alt="">';
		} else {
			echo JLayoutHelper::render( 'joomla.content.post_formats.post_' . $post_format, array(
				'params' => $params,
				'item'   => $this->item
			) );
		}
		...
		<div class="entry-header<?php echo $has_post_format ? ' has-post-format' : ''; ?>">
			...
			<div class="recipe-other">
				<?php
					echo JLayoutHelper::render( 'joomla.content.post_formats.post_obcake_generalinfo' , array(
						'params' => $params,
						'item'   => $this->item
					) );
				?>
		...
		<?php if ( $params->get( 'access-view' ) ): ?>
			...
			<div itemprop="articleBody" class="main_content">
				<div class="row">
					<div class="col-md-8 instructions">
						<div class="recipe_content">
							<h3 class="introduction-recipe"><?php echo JText::_('CAKE_ART_INSTRUCTION_RECIPE'); ?></h3>
							<?php echo $this->item->text; ?>
						</div>
						<div class="recipe-instructions">
							<?php
								echo JLayoutHelper::render( 'joomla.content.post_formats.post_obcake_instruction' , array(
									'params' => $params,
									'item'   => $this->item
								) );
							?>
					...
					<div class="col-md-4">
						<?php if($params->get( 'show_vote' )) {?>
							<div class="recipe-ratings">
								<h3 class="rating-title"><?php echo JText::_('CAKE_ART_RATING_RECIPE');?></h3>
								<div class="rating_recipes">
									<?php echo JLayoutHelper::render( 'joomla.content.rating', array(
										'item'     => $this->item,
										'params'   => $params,
										'position' => 'below'
									) ) ?>
						...
						<?php }?>
						<?php
							echo JLayoutHelper::render( 'joomla.content.post_formats.post_obcake_ingredients' , array(
								'params' => $params,
								'item'   => $this->item
							) );
						?>
			...
			<div class="relate_recipes">
				<?php
				$document = JFactory::getDocument();
				$renderer   = $document->loadRenderer('modules');
				$position   = 'relate_recipes';
