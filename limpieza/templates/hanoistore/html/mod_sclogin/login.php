...
?>
    ...
    <div class="sclogin sourcecoast" id="sclogin-<?php echo $module->id; ?>">
        <div class="head_form">
            <span class="hi"><?php echo JText::_('VS_HELLO');?><strong><?php echo JText::_('VS_GUEST');?></strong></span>
            <a href="" class="link"><?php echo JText::_('VS_SIGNIN');?> <i class="zmdi zmdi-caret-down"></i></a>
        ...
        <div class="form_log">
            <h3 class="title_popup"><?php echo JText::_('VS_SIGNIN');?></h3>
            <div class="row-fluid">
                <?php
