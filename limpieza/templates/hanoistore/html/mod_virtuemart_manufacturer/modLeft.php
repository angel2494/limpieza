...
if ($display_style =="div") { ?>
	<div class="vmmanufacturer<?php echo $params->get('moduleclass_sfx'); ?> mod_left">
	<?php foreach ($manufacturers as $manufacturer) {
		...
		if ($show == 'text' or $show == 'all' ) { ?>
				<a href="<?php echo $link; ?>"><i class="fa fa-caret-right" aria-hidden="true"></i> <?php echo trim($manufacturer->mf_name); ?></a>
		<?php
		} ?>
		</div>
		<?php
