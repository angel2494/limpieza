...
<div class="total_products">
	<label><?php echo JText::_('VS_MY_CART'); ?></label>
	<a href=""><?php echo count($data->products);?> <?php echo JText::_('VS_ITEMS'); ?> - <strong><?php echo $data->billTotal_discounted_net; ?></strong></a>
</div>
