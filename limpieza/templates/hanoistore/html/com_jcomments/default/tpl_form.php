			...
			<form id="comments-form" name="comments-form" action="javascript:void(null);">
				...
				<div class="row">
					<div class="col-sm-12 col-xs-12">
							<textarea placeholder="Your comment (required)" id="comments-form-comment" name="comment" cols="65" rows="8" tabindex="5"></textarea>
					</div>
				</div>
				<div class="row">
					<div class="col-sm-6 col-xs-12">
						<?php if ($this->getVar( 'comments-form-user-name', 1) == 1) {?>
							<input placeholder="Name (required)" id="comments-form-name" type="text" name="name" value="" maxlength="<?php echo $this->getVar('comment-name-maxlength');?>" size="22" tabindex="1" />
						<?php }?>
					</div>
					<div class="col-sm-6 col-xs-12">
						<?php if ($this->getVar( 'comments-form-user-email', 1) == 1) {?>
							<input placeholder="Email (required)" id="comments-form-email" type="text" name="email" value="" size="22" tabindex="2" />
						<?php }?>
					</div>
				</div>
				<?php
				...
				<div id="comments-form-buttons">
					<div class="btn" id="comments-form-send"><div><a class="sppb-btn-ob_btn_primary" href="#" tabindex="7" onclick="jcomments.saveComment();return false;" title="<?php echo JText::_('FORM_SEND_HINT'); ?>"><?php echo JText::_('FORM_SEND'); ?> <i class="fa fa-angle-right"></i></a></div></div>
