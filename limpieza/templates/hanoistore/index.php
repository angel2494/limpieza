...
if($pageclass) $body_classes .= ' body_'.$pageclass;
...
<head>
    ...
    $this->helix3->addCSS('bootstrap.min.css, font-awesome.min.css, material-design-iconic-font.min.css') // CSS Files
        ->addJS('bootstrap.min.js, jquery.sticky.js, jquery.bxslider.min.js, waypoints.min.js, main.js') // JS Files
